...
#### 3.1.1
 - 2019-11-25 - [1 commit](https://github.com/yakworks/grails-freemarker/compare/v3.1.0...v3.1.1) by [alexeyzvegintcev](https://github.com/alexeyzvegintcev) - published to [![Bintray](https://img.shields.io/badge/Bintray-3.1.1-green.svg)](https://bintray.com/null/null/org.grails.plugins/3.1.1)
 - Java8 dates handling [(#5)](https://github.com/yakworks/grails-freemarker/pull/5)

#### 3.1.0
 - 2019-05-08 - [1 commit](https://github.com/yakworks/grails-freemarker/compare/v3.0.3...v3.1.0) by [Joshua](https://github.com/basejump) - published to [![Bintray](https://img.shields.io/badge/Bintray-3.1.0-green.svg)](https://bintray.com/null/null/org.grails.plugins/3.1.0)
 - No pull requests referenced in commit messages.

#### 3.0.3
 - 2019-05-08 - 179 commits by 9 authors - published to [![Bintray](https://img.shields.io/badge/Bintray-3.0.3-green.svg)](https://bintray.com/null/null/org.grails.plugins/3.0.3)
 - Commits: Joshua Burnett (61), Alexey Zvegintcev (31), Jeff Brown (22), brownj (18), Daniel Henrique Alves Lima (17), [sudhir nimavat](https://github.com/snimavat) (12), [Joshua](https://github.com/basejump) (10), Ken Roberts (7), [Burt Beckwith](https://github.com/burtbeckwith) (1)
 - clean up [(#4)](https://github.com/yakworks/grails-freemarker/pull/4)
 - Grails339 & Shipkit [(#3)](https://github.com/yakworks/grails-freemarker/pull/3)
 - Misc cleanup [(#1)](https://github.com/yakworks/grails-freemarker/pull/1)
