...
//        controller.viewResourceLocator = viewResourceLocator
    ...
    void "view with plugin controller in request"() {
        ...
        String toCompare = "grails-kit-plugin/grails-app/views/fooPlugin/index.md"
        String toCompare2 = "grails-kit-plugin-0.1.jar!/fooPlugin/index.md"
    ...
    void "view using plugin path"() {
        when:
        //controller.viewResourceLocator = viewResourceLocator
        Resource res = viewResourceLocator.locate('/plugins/grails-kit-plugin-0.1/fooPlugin/index.md')
